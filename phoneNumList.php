...
if (!empty($cname) && !empty($cnumber)) {
	...
	$sql="INSERT INTO contacts (contact_name,mobile_number,user_id) VALUES('$cname','$cnumber','$id_n')";
$result=mysqli_query($conn,$sql);

		header("Location: dashboard.php?id=".$id_n);
		exit();
...
<body>
	...
	<div class="container">
		...
		<div class="col-md-6">
			...
			<hr>
			<form class="form-horizontal"  method="post" action="phoneNumList.php">
				<br>
